parameters<-c(Environmental.Policy = 0.0 , # [1] 0: current policy, 1: response type 1, 2: response type 2 and 3: response type 3
              Birth.Rate.base = 0.03646399, # [%/year] population estimation based on stable behavior over the last years with permits [aerial survey data (Lee, 2016) open access data; and Lee, R. 1997. Status of bighorn sheep in Mexico. Desert Bighorn Council Transactions 41:79–80]
              Death.Rate.base = 0.01, # [%/year]  population estimation based on stable behavior over the last years with permits. Similar to bighorn sheep population death rate in a National Recreation Area in Montana, U.S.A (Roelle, 2004)
